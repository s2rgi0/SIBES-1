...
//ESPECIE
	    ...
	    if(id_r != null && id_d == null && id_c == null && id_o == null && id_f == null && id_g == null && id_e == null ){
            ...
            success:function(data){
            	...
            	tob = '<div class="row"><div class="col-md-1" ></div><div class="col-md-13" ><table id="resultados" class="table table-striped table-bordered table-hover" width="100%" cellspacing="0" style="background-color: white;" ><thead></thead> <tbody class="row_consulta"></tbody></table></div></div>';

            	if(data.length == 1){
            		msg = '<h4 style="float:left;"><p>Se encontro '+data.length+' resultado</p></h4>';
            	}else{
            		msg = '<h4 style="float:left;"><p>Se encontraron '+data.length+' resultados</p></h4>';
            	}
            	...
            	for(var i = 0 ; i < data.length ; i++ )
                    {
                    	...
                    	if( data[i].nombreSubespecie ){
                    		...
                    		if( data[i].fotografiaEspecie2 ){

                    			i_a+= '<tr><td><div class="row" style="padding-left: 15px;" ><label>Nombre Subespecie : </label>'+data[i].nombreSubespecie+'</div><div class="row"><div class="col-md-3" ><label>Reino : </label>'+ data[i].nombreReino +'<br><label>Division : </label>'+data[i].nombreDivision+'<br><label>Clase : </label> '+data[i].nombreClase+'<br></div><div class="col-md-3" ><label>Orden : </label>'+data[i].nombreOrden +'<br><label>Familia : </label>  '+data[i].nombreFamilia +'<br></div><div class="col-md-3" ><label>Genero : </label> '+data[i].nombreGenero+'<br><label>Especie : </label> '+data[i].nombreEspecie +'<form method="get" action="Avista_sub_pub" id="info_sub" ><input type="hidden" name="id_sub" value="'+data[i].idSubespecie+'" id="id_sub" class="" ><br><button  class="btn btn-default btn-sm btn-Ver_sub" value="'+data[i].idSubespecie+'" >Información</button></form></div><div class="col-md-3" ><div style="padding-bottom: 10px;" ><img src="/imagen_especie/'+data[i].nombreEspecie+'/'+data[i].nombreSubespecie+'/'+data[i].fotografiaEspecie2+'"  id="img-avista" class="img-rounded" width="125" height="100" ></div></div></td></tr>';
	

                    		}else{

                    			i_a+= '<tr><td><div class="row" style="padding-left: 15px;" ><label>Nombre Subespecie : </label>'+data[i].nombreSubespecie+'</div><div class="row"><div class="col-md-3" ><label>Reino : </label>'+ data[i].nombreReino +'<br><label>Division : </label>'+data[i].nombreDivision+'<br><label>Clase : </label> '+data[i].nombreClase+'<br></div><div class="col-md-3" ><label>Orden : </label>'+data[i].nombreOrden +'<br><label>Familia : </label>  '+data[i].nombreFamilia +'<br></div><div class="col-md-3" ><label>Genero : </label> '+data[i].nombreGenero+'<br><label>Especie : </label> '+data[i].nombreEspecie +'<form method="get" action="Avista_sub_pub" id="info_sub" ><input type="hidden" name="id_sub" value="'+data[i].idSubespecie+'" id="id_sub" class="" ><br><button  class="btn btn-default btn-sm btn-Ver_sub" value="'+data[i].idSubespecie+'" >Información</button></form></div><div class="col-md-3" ><div style="padding-bottom: 10px;" ><img src="/imagen/placeholder.png"  id="img-avista" class="img-rounded" width="125" height="100" ></div></div></td></tr>';
                    		...
                    		if( data[i].fotografiaEspecie ){

                    			i_a+= '<tr><td><div class="row" style="padding-left: 15px;" ><label>Nombre Especie : </label>'+data[i].nombreEspecie+'</div><div class="row"><div class="col-md-3" ><label>Reino : </label>'+ data[i].nombreReino +'<br><label>Division : </label>'+data[i].nombreDivision+'<br></div><div class="col-md-3" ><label>Clase : </label> '+data[i].nombreClase+'<br><label>Orden : </label>'+data[i].nombreOrden +'<br></div><div class="col-md-3" ><label>Familia : </label>  '+data[i].nombreFamilia +'<br><label>Genero : </label> '+data[i].nombreGenero+'<br><form method="get" action="Avista_esp_pub" id="info_esp" ><input type="hidden" name="id_esp" value="'+data[i].idEspecie+'" id="id_esp" class="" ><br><button  class="btn btn-default btn-sm btn-Ver_sub" value="'+data[i].idEspecie+'" >Información</button></form></div><div class="col-md-3" ><div style="padding-bottom: 10px;" ><img src="/imagen_especie/'+data[i].nombreEspecie+'/'+data[i].fotografiaEspecie+'"  id="img-avista" class="img-rounded" width="125" height="100" ></div></div></td></tr>';
                    ...
                    row.find('.row_consulta').append(i_a);
