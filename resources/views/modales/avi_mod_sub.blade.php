...
<div class="modal fade " id="VER_Avista_Modal"   role="dialog">
      ...
      <div class="modal-dialog modal-lg ">
        ...
        <div class="modal-header"  id="modal-h">
            ...
            <h4 class="modal-title"> Modificar información del avistamiento de la subespecie: {{ $esp->nombreSubespecie }}   </h4>
        </div>
...
<input class="form-control" id="Longitud-VER"  name="long_avis_ver" placeholder="O 89° 6' 26.499''" >
              ...
              <div class="form-group row">
                <div class="col-xs-12 col-md-6">
                  <label>Fotografia de avistamiento: </label><a style="color: #a3a375 ;"> gif, png, bmp, jpg</a>
                    <br>
                ...
                <div class="col-xs-12 col-md-6" >
                  ...
                  <input class="form-control" id="num_avis_edit"  name="num_avis_edit">
                  <center>
            ...
            <div class="form-group row" >
              ...
              <div class="col-xs-12 col-md-6">
                  ...
                  <br>
                   -->
                  <input aria-describedby="fileHelp" class="form-control-file" id="id_PubPDF_edit_sub" type="file" name="pdf_avista_doc_edit" >
                  <br>
                  <center>
              ...
              <div class="col-xs-12 col-md-6">
                  ...
                  <button class="btn btn-default" type="submit" id="guardar_link_edit_sub" style="width: 100%;">Agregar documento PDF  <span class="glyphicon glyphicon-plus" aria-hidden="true"  ></span></button>
                  <br>
              </div>
              </div>
              <div class="form-group row" >
  ...
  <div class="modal-dialog modal-lg ">
    ...
    <div class="modal-content">
      <div class="modal-header"  id="modal-h">
          ...
          <h4 class="modal-title"> Información  de avistamiento de la subespecie: {{ $esp->nombreSubespecie }}  </h4>
      </div>
      <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
      <div class="modal-body" id="modal-body-view"  style="padding: 25px;" >
          ...
          <article>
            ...
            <div  class="form-group row ">
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                <div class="col-xs-12 col-md-6">
                    <label for="ClimaTextarea">Descripción del clima:</label>
                    <p id="clima-avista" ></p>
                </div>
                <div class="col-xs-12 col-md-6">
                    <label for="EcoTextarea">Descripción del ecosistema:</label>
                    <p id="eco-avista" ></p>
                ...
                <div class="form-group row">
                  <div class="col-xs-12 col-md-6">
                      <label for="FisioTextarea"> Descripción de  fisiografía:</label>
                      <p id="fisio-avista" ></p>
                  </div>
                  <div class="col-xs-12 col-md-6">
                      <label for="GeoTextarea">
                ...
                <div class="form-group row">
                    <div class="col-xs-12 col-md-6">
                        <label for="HidroTextarea">Descripción de hidrografía: </label>
                        <p id="hidro-avista" ></p>
              ...
              <div class="form-group row">
                <div class="col-xs-12 col-md-12">
                  <label>Publicación en PDF:</label>
                  <br><br>
...
<div class="modal fade " id="PDF_avis_sub"   role="dialog">
              ...
              <div class="form-group row">
                <div class="col-xs-12 col-md-12">
                  ...
                  <br>
                      ...
                      <!--
                      <input class="form-control" id="pdf_avista_doc" name="pdf_avista_doc" >
                      -->
