    ...
    $('#frm-editar_sub button').click(function(e){
        ...
        if($(this).attr("id")=="guardar_link_edit_sub"){
            ...
            if( $('#id_PubPDF_edit_sub').val() ){
                    //alert('si tiene algo')
                    var link  = $('#id_PubPDF_edit_sub').val();
                    //alert(link)
                    var div = $('#link_edit_sub');
                    var esc = $('#esc_edit_sub');
                    div.find('#pub_PDF_edit_sub').append(link);
                    esc.find('#publish_edit_sub').append(link);
                    $("#id_PubPDF_edit_sub").val("");
                    var espacio = '\n';
                    div.find('#pub_PDF_edit_sub').append(espacio);
                    //div.find('#pub_PDF2').append(espacio);
                    esc.find('#publish_edit_sub').append(espacio);
                }else{
                }
         }
