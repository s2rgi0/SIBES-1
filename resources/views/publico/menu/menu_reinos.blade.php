<nav class="navbar navbar-inverse sidebar" role="navigation" style="background-color: #aa913f;" >
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active" style="background-color: #999;"><a  style="font-family: 'Raleway', sans-serif; color: #fff;" href="SistemadeBiodiversidadsv" > SIBES <span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
        ...
        <li ><a><center> <label class="btn btn-success" id="reino_tax"  >  Descargar <span class="glyphicon glyphicon-save" aria-hidden="true"  ></span> </label> </center> </a></li>
       <!-- <li ><a></a></li>-->
      </ul>
    </div>
