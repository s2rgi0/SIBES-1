<nav class="navbar navbar-inverse sidebar" role="navigation" style="background-color: #aa913f;" >
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" style="color: white;" data-toggle="dropdown"><i class="fa fa-globe"></i> <i class="fi-crown"></i> Departamentos  <span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity white"></span></a>
        ...
        <li ><a><center> <label class="btn btn-success" id="desc_avista_uni"  >  Descargar <span class="glyphicon glyphicon-save" aria-hidden="true"  ></span> </label> </center> </a></li>
       <!-- <li ><a></a></li>-->
      </ul>
    </div>
