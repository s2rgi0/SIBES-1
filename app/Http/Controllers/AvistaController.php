...
class AvistaController extends Controller
{
    ...
    public function SAVE_avista(Request $req)
    {
        ...
        $validator = Validator::make(Input::all(), [
            ...
            'num_avis.numeric'     => 'Debe de Ingresar un dato numérico',
            ...
            'depar_avis.required'  => 'Elija un departamento',
            'mun_avis.required'    => 'Elija un municipio',
            'canton_avis.required' => 'Elija un cantón',
            'fecha_av.required'    => 'Debe ingresar una fecha',
            'alt_avis.numeric'     => 'Ingrese un dato numérico',
    ...
    public function SAVE_edit(Request $req)
    {
        ...
        $validator = Validator::make(Input::all(), [
            ...
            'num_avis_edit.numeric'    => 'Debe de Ingresar un dato numérico',
    ...
    public function SAVE_avista_sub(Request $req)
    {
        ...
        $validator = Validator::make(Input::all(), [
            ...
            'num_avis.numeric'     => 'Debe ingresar un dato numérico',
            'foto_graf.image'      => 'No es una imagen',
