...
class ModalesController extends Controller
{
    ...
    public function nueva_div(Request $req)
    {
        ...
        $data = Division::select('idDivision', 'nombreDivision')->orderBy('created_at', 'desc')->where('idReino', $req->id)->get();
    ...
    public function nueva_cla(Request $req)
    {
        ...
        $data = Clase::select('idClase', 'nombreClase')->orderBy('created_at', 'desc')->where('idDivision', $req->id)->get();
    ...
    public function nueva_ord(Request $req)
    {
        ...
        $data = Orden::select('idOrden', 'nombreOrden')->orderBy('created_at', 'desc')->where('idClase', $req->id)->get();
    ...
    public function nueva_fam(Request $req)
    {
        ...
        $data = Familia::select('idFamilia', 'nombreFamilia')->orderBy('created_at', 'desc')->where('idOrden', $req->id)->get();
    ...
    public function nueva_gen(Request $req)
    {
        ...
        $data = Genero::select('idGenero', 'nombreGenero')->orderBy('created_at', 'desc')->where('idFamilia', $req->id)->get();
    ...
    public function nueva_esp(Request $req)
    {
        ...
        $data = Especie::select('idEspecie', 'nombreEspecie')->orderBy('created_at', 'desc')->where('idGenero', $req->id)->get();
    ...
    public function nueva_sub(Request $req)
    {
        ...
        $data = Subespecie::select('idSubespecie', 'nombreSubespecie')->orderBy('created_at', 'desc')->where('idEspecie', $req->id)->get();
...
//////////////////////////////////////////GET FAM //////////////////////
    ...
    public function estadoMarn_sub(Request $req)
    {
        ...
        $d = Subespecie::select('estadoMarn')->where('idSubespecie', $req->id)->get();
    ...
    public function agarra_esp(Request $req)
    {
        ...
        $t_esp  = Clasesdetipo::join('Especies','Clasesdetipo.idClaseDeTipo','=','Especies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Especies.idEspecie', $req->esp_id)->get();
    ...
    public function agarra_sub(Request $req)
    {
        ...
        $t_sub  = Clasesdetipo::join('Subespecies','Clasesdetipo.idClaseDeTipo','=','Subespecies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Subespecies.idSubespecie', $req->sub_id)->get(); 
    ...
    public function Informacion(Request $req)
    {
        ...
        $t_esp  = Clasesdetipo::join('Especies','Clasesdetipo.idClaseDeTipo','=','Especies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Especies.idEspecie', $req->id_esp)->get(); 
    ...
    public function Informacion_Sub(Request $req)
    {
        ...
        $t_sub  = Clasesdetipo::join('Subespecies','Clasesdetipo.idClaseDeTipo','=','Subespecies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Subespecies.idSubespecie', $req->id_sub)->get(); 
    ...
    public function informacion_avis(Request $req)
    {
        ...
        $t_esp  = Clasesdetipo::join('Especies','Clasesdetipo.idClaseDeTipo','=','Especies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Especies.idEspecie', $id)->get(); 
    ...
    public function informacion_avis_sub( Request $req )
    {
        ...
        $t_sub  = Clasesdetipo::join('Subespecies','Clasesdetipo.idClaseDeTipo','=','Subespecies.idClaseDeTipo')->select('ClasesDeTipo.nombreClaseDeTipo','ClasesDeTipo.idClaseDeTipo')->where('Subespecies.idSubespecie', $id_sub)->get(); 
